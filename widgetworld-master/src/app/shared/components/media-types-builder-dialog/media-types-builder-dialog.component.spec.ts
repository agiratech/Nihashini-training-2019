...
// import { MediaTypesFilterComponent } from '../media-types-filter/media-types-filter.component';
...
@Component({ selector: 'app-media-types-filter', template: '' })
class MediaTypesFilterComponent { }
...
describe('MediaTypesBuilderDialogComponent', () => {
  ...
  beforeEach(async(() => {
    ...
    TestBed.configureTestingModule({
      ...
      declarations: [ MediaTypesBuilderDialogComponent, MediaTypesFilterComponent ],
      providers: [
