...
export class LoginComponent implements OnInit, OnDestroy {
  ...
  themeSettings: any;
  @ViewChild('close_reset', { static: false }) closeReset: ElementRef;
  ...
  constructor(private formBuilder: FormBuilder,
    ...
    private projectStore: ProjectDataStoreService, private titleService: TitleService) {

    this.exploreService.cancelSlowMessage(this.exploreService);
    const mobileAlertSeen: string = localStorage.getItem('mobile_alert_seen');
  }
  ngOnInit() {
  ...
  submitToServer(formData) {
    this.authentication.login(formData).subscribe(response => {
