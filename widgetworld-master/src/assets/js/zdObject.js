...
if(hostname == "gp.intermx.io" || hostname == "geopath.intermx.com"  || hostname == "www.geopath.io" || hostname == "gisdev.geopath.io")
{
  ...
  window.onload=function(){var s=document.createElement("script");s.type="text/javascript";s.src="https://static.zdassets.com/ekr/snippet.js?key=498bd9a2-e5f1-4bf0-b6e0-731cb3e27904";s.id="ze-snippet";try{document.body.appendChild(s)}catch(e){document.body.appendChild(s)}};
}
else
{
...
var zdObject = (function() {
  return {
    ...
    open: function() {
      ...
      if(subdomain != "localhost")
      {
        if(typeof help.status !== "undefined" && module_access.status == "active")
        {
          zE( function () {
            zE.activate();
          });
